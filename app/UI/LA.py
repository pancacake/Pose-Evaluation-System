...
class LA(QtWidgets.QWidget):
    ...
    def setupUi(self):
        ...
        self.label.setPixmap(QtGui.QPixmap(r"D:\pose-evaluation\HoT-main\demo\usr_vis\left_leg\standard_left_leg.jpg"))  # Replace with your image path

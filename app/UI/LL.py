...
class LL(QtWidgets.QWidget):
    ...
    def setupUi(self):
        ...
        self.label.setPixmap(QtGui.QPixmap(r"D:\pose-evaluation\HoT-main\demo\usr_vis\left_arm\standard_left_arm.jpg"))  # Replace with your image path

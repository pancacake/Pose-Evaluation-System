...
class RA(QtWidgets.QWidget):
    ...
    def setupUi(self):
        ...
        self.label.setPixmap(QtGui.QPixmap(r"D:\pose-evaluation\HoT-main\demo\usr_vis\right_arm\standard_right_arm.jpg"))  # Replace with your image path

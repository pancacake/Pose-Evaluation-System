...
class AIInfo(HeaderCardWidget):
    ...
    def __init__(self, parent=None):
        ...
        self.textEdit.setFixedWidth(500)
...
class VIDInterface(GalleryInterface):
    """ AI 接口 """
    ...
    def __init__(self, parent=None):
        ...
        self.setObjectName('VIDInterface')
        self.aiinfo = AIInfo()
    ...
    def createHorizontalGroupCards(self):
        ...
        self.aiinput.setMinimumWidth(550)
        self.aiinfo.setMinimumWidth(550)
